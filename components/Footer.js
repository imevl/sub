      ...
      <div class="col-12 col-md-10 left-section">
        <div class="brand-logo">
          <a class="navbar-brand" href="#">
            <img class="BrandLogo" src="./Images/Logo-BgDark.svg" alt="Pet Food Subscription Logo" srcset="" />
          </a>
        </div>
        ...
        <div class="copyrights mt-4">
          © 2024 <a class='text-decoration-underline' href="https://github.com/SuccessfullSites">PetFoodSubscription</a> Theme. All rights reserved.
        </div>
      </div>
